...
- [memberclicks-directory-export-guide](https://github.com/willowridge1234/memberclicks-directory-export-guide) — Guide — the same situation on Wild Apricot's sister platform, MemberClicks
